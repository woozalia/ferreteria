...
/* =============================
  ...
  HISTORY:
    ...
    2016-12-02 Removed fcCacheFile (that's in util/cache-file.php now), moved this to db.v1, and renamed it data-cache-mgr.php.
      As far as I can tell, though, not even VbzCart is currently using it. Not listed in module lists.
*/
