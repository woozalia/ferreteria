...
/*%%%%
  ...
  TODO: Why isn't clsContentProps a Table type?
*/
class clsContentProps {
    ...
    protected function PagePropertiesTable() {
	return $this->Database()->MakeTableWrapper('w3ctProperties');
    }
